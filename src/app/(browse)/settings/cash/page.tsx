...
const CashPage = () => {
  return (
    <div className="form_custom">
      ...
      <div className="row flex flex-center gapy-40 mt-16 flex-col">
        ...
        <div className="flex flex-col md:flex-row">
          <div className="col-12 col-md-12 col-xl-5 col-history flex-[33%]">
            <form action="">
          ...
          <div className="col-12 col-md-12 col-xl-7 flex-[66%]">
